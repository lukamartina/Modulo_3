class Scene2 extends Phaser.Scene {
    ...
    create ()
    {
        ...
        //  The score
        scoreText = this.add.text(16, 16, 'score: 0', { fontSize: '20px', fill: '#2E37F5', fontFamily: "Arial" });
        ...
        timeText = this.add.text(500, 16, '', { fontSize: '20px', fill: '#2E37F5', fontFamily: "Arial" });
